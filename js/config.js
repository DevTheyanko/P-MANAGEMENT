...
export const CONFIG = {
  ...
  // ── Personas ─────────────────────────────────────────────────────
  // Lista que aparece al abrir la app. También pueden escribir otro nombre.
  USUARIOS: ['Gaston', 'Jean', 'Deibis', 'Alfredo', 'Midgalia', 'Laura'],

  // PIN de administrador POR USUARIO, guardado como huella SHA-256 (no en
  // texto plano). Cada persona de USUARIOS puede tener su propio PIN para
  // entrar en modo administrador. Quien no esté en esta lista (por ejemplo,
  // alguien que escribió su nombre en "Otro nombre") usa PIN_ADMIN_DEFECTO_SHA256.
  // Los valores de abajo corresponden TODOS al PIN de ejemplo 2580 — para
  // darle a alguien un PIN propio, genera su hash como en GUIA.md (paso 4)
  // y reemplaza solo su línea.
  PINES_ADMIN_SHA256: {
    Gaston: 'c28b39301e7e776610caa863459bf05c4fc9890471d9c77ad061253930dc36ff',
    Jean: 'c28b39301e7e776610caa863459bf05c4fc9890471d9c77ad061253930dc36ff',
    Deibis: 'c28b39301e7e776610caa863459bf05c4fc9890471d9c77ad061253930dc36ff',
    Alfredo: 'c28b39301e7e776610caa863459bf05c4fc9890471d9c77ad061253930dc36ff',
    Midgalia: 'c28b39301e7e776610caa863459bf05c4fc9890471d9c77ad061253930dc36ff',
    Laura: 'c28b39301e7e776610caa863459bf05c4fc9890471d9c77ad061253930dc36ff',
  },
